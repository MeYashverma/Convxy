                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/MeYashverma/Convxy/releases/download/${currentStatus.version}/convx-${currentStatus.version}.apk"
...
private fun fetchNightlyArtifactSize(runId: Long): String = try {
    val artifactsUrl =
        URL("https://api.github.com/repos/MeYashverma/Convxy/actions/runs/$runId/artifacts")
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/MeYashverma/Convxy/releases")
            ...
            if (betaEnabled) {
                try {
                    val nightlyUrl = URL("https://api.github.com/repos/MeYashverma/Convxy/actions/workflows/nightly.yml/runs?status=success&per_page=1")
            ...
            if (isNightlyUpdate && nightlyRunObject != null) {
                ...
                val apkDownloadUrl = "https://nightly.link/MeYashverma/Convxy/workflows/nightly.yml/main/convx-gms-nightly.zip"
            ...
            if (targetRelease != null) {
                ...
                if (shouldShow) {
                    ...
                    try {
                        val changelogUrl =
                            URL("https://github.com/MeYashverma/Convxy/releases/download/$tagWithPrefix/changelog.json")
