        ...
        OnboardingPageInfo(
            content = { _ ->
                Column(
                    ...
                    Text(
                        text = "Convxy is open-source and depends on community support to grow. Your help makes a difference!",
                        style = MaterialTheme.typography.bodyLarge.copy(
                            fontFamily = GoogleSansFlex
                        ),
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    ...
                    Column(
                        ...
                        PermissionCard(
                            ...
                            onClick = {
                                uriHandler.safeOpenUri(context, "https://github.com/MeYashverma/Convxy")
                            }
                        )
                        ...
                        PermissionCard(
                            ...
                            onClick = {
                                uriHandler.safeOpenUri(context, "https://discord.gg/GquSGfs2u")
                            }
                        )
