...
object UpdateNotificationHelper {
    ...
    fun showUpdateNotification(context: Context, versionName: String) {
        ...
        val apkUrl = if (versionName.contains("nightly", ignoreCase = true)) {
            "https://nightly.link/MeYashverma/Convxy/workflows/nightly.yml/main/convx-gms-nightly.zip"
        } else {
            "https://github.com/MeYashverma/Convxy/releases/download/$versionName/convx-$versionName.apk"
        }
